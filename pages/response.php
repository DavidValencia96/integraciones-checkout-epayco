<!DOCTYPE html>
    ...
    <header id="main-header" style="margin-top:20px">
        ...
        <div class="col-lg-12 franja">
            <img class="center-block" src="https://multimedia.epayco.co/epayco-landing/btns/epayco-logo-fondo-oscuro.png">
        </div>
        </div>
    </header>
    <div class="container">
        ...
        <div class="col-lg-8 col-lg-offset-2 ">
            <h4 style="text-align:left"> Respuesta de la Transacción </h4> <br>
            <a href="http://localhost/test-epayco/"> Ir al inicio</a><br><br>
            <a href="http://localhost:8100/tabs/tab1"> Ir al inicio en ANGULAR</a>
            <hr>
        </div>
        <div class="col-lg-8 col-lg-offset-2 ">
    ...
    <script>
        ...
        // console.log("data: " + urlapp);

        $.get(urlapp, function(response) {


            if (response.success) {
                console.log("data response --> " +  urlapp + " <-- : ");
            ...
            $('#x_ref_payco').text(response.data.x_ref_payco);
